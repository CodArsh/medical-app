...
@available(iOS 13.0, *)
@objc(EyeTrackController) public class EyeTrackController: NSObject {
    ...
    public var onUpdate: (EyeTrackInfo?) -> Void {
        get {
            print("Eye Tracking onUpdate get called")
            return self.eyeTrack.onUpdate
        }
        set {
            print("Eye Tracking onUpdate set called")
    ...
    public var view: EyeTrackView {
        get {
            print("Eye Tracking getView called")
            if self._view == nil {
                print("Eye Tracking getView nil")
...
//        super.init()
        print("Eye Tracking Controller Init called nil")
